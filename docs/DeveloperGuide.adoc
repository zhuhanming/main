...
1. User enter list event command. +
2. Modulo will display all the events with numbering index in the left panel. +
3. User enter view 1 to view the details of the event. +
4. Modulo display the event details and its deadline on the right panel. +
5. User enter index of deadline. e.g: done 1. +
6. Modulo checks is if the index is valid or not and toggles the completion status of the deadline.
...
1. User <<UseCaseNine,list all the registered module (UC09)>>. +
2. User enter view command, e.g view 1(index). +
