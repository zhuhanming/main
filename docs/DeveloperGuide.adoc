...
Given below is a activity diagram to show how the done mechanism behaves at each step.
...
* **Alternative 2 :** Modulo will keep track of deadline's status and update every week
** Pros: User
