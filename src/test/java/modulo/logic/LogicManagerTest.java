...
public class LogicManagerTest {
    ...
    public void getFilteredModuleList_modifyList_throwsUnsupportedOperationException() {
        assertThrows(UnsupportedOperationException.class, () -> logic.getFilteredFocusedList().remove(0));
    }
     ...
     */
    private static class JsonAddressBookIoExceptionThrowingStub extends JsonModuloStorage {
