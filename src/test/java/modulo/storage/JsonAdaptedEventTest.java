...
public class JsonAdaptedEventTest {
    ...
    private static final String INVALID_SLOT = "Hello world!";
    ...
    private static final String VALID_SLOT = TUTORIAL_1.getSlot().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(INVALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                VALID_EVENT_END, VALID_PARENT_MODULE_CODE, VALID_ACADEMIC_YEAR, VALID_LOCATION,
                VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_invalidEventEnd_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                INVALID_DATETIME, VALID_PARENT_MODULE_CODE, VALID_ACADEMIC_YEAR, VALID_LOCATION,
                VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_nullEventEnd_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                null, VALID_PARENT_MODULE_CODE, VALID_ACADEMIC_YEAR, VALID_LOCATION,
                VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_invalidParentModuleCode_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                VALID_EVENT_END, INVALID_PARENT_MODULE_CODE, VALID_ACADEMIC_YEAR, VALID_LOCATION,
                VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_nullParentModuleCode_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                VALID_EVENT_END, null, VALID_ACADEMIC_YEAR, VALID_LOCATION, VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_invalidAcademicYear_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                VALID_EVENT_END, VALID_PARENT_MODULE_CODE, INVALID_ACADEMIC_YEAR, VALID_LOCATION,
                VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_nullAcademicYear_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                VALID_EVENT_END, VALID_PARENT_MODULE_CODE, null, VALID_LOCATION, VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_invalidLocation_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                VALID_EVENT_END, VALID_PARENT_MODULE_CODE, VALID_ACADEMIC_YEAR, INVALID_LOCATION,
                VALID_SLOT, VALID_DEADLINES);
    ...
    public void toModelType_nullLocation_throwsIllegalValueException() {
        JsonAdaptedEvent event = new JsonAdaptedEvent(VALID_NAME, VALID_EVENT_TYPE, VALID_EVENT_START,
                VALID_EVENT_END, VALID_PARENT_MODULE_CODE, VALID_ACADEMIC_YEAR, null, VALID_SLOT, VALID_DEADLINES);
